...
export default function MudresSettingsPage() {
    ...
    <DashboardShell>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, marginBottom: 22, flexWrap: "wrap" }}>
        ...
        {tab === "account" ? (
          <button
            ...
            style={{
              background: DARK, color: WHITE, border: "none", borderRadius: 999, padding: "10px 20px",
          ...
          return (
            <button
              ...
              style={{
                ...
                border: "none", borderBottom: active ? `2px solid ${DARK}` : "2px solid transparent",
      ...
      {tab === "account" && (
        <div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 22 }}>
            <span style={{ width: 52, height: 52, borderRadius: "50%", background: DARK, color: WHITE, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 19, fontWeight: 700, flex: "0 0 auto" }}>
              {initial}
            </span>
            <div>
      ...
      {tab === "security" && (
        <div>
          ...
          <p style={{ color: MUTED, fontSize: 12.5, margin: "0 0 22px" }}>
            Choose a new password for signing in to your MUDRES account.
          </p>
