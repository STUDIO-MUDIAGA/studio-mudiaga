...
const COLUMNS = [
  ...
  },
  {
    title: "Projects",
    links: [
      { label: "Project Abode", href: "/projects/abode" },
      { label: "Project UB", href: "/projects/ub" },
    ],
  },
  {
    title: "Legal",
...
export default function Footer() {
  return (
    <footer className="bg-[#0a0a0a] border-t border-white/10">
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "clamp(56px, 7vw, 96px) clamp(24px, 4vw, 48px) clamp(32px, 4vw, 48px)" }}>
        <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr_1fr_1fr] gap-y-14 gap-x-10">
          {/* Brand */}
          <div>
            <Link href="/" className="inline-flex items-center">
              <Image src="/Group.svg" alt="Studio Mudiaga" width={150} height={24} unoptimized />
            </Link>
            <p
